...
import "./libs/rocketswap-lib/security/ReentrancyGuard.sol";

contract SmartBotdexInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart refiner factory
    address public SMART_REFINER_FACTORY;
    ...
    constructor() {
        SMART_REFINER_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == SMART_REFINER_FACTORY, "Not factory");
